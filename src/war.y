...
%token TOKEN_TYPE_LLVM_INT TOKEN_TYPE_INT TOKEN_TYPE_BOOL TOKEN_TYPE_REAL TOKEN_TYPE_LLVM_FLOAT TOKEN_TYPE_LLVM_DOUBLE TOKEN_TYPE_STRUCT
...
%right PREC_CAST '!' '~' PREC_UMINUS PREC_REF PREC_DEREF
%left '[' ']' '{' '}'
%%
top_level:
